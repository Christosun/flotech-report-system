...
def build_onsite_pdf(rid):
    ...
    digital_notice = Table([[
        Paragraph(
            f'<font color="#6B7280" size="7.5">🔒  Dokumen ini digenerate secara digital oleh sistem PT. Flotech Controls Indonesia'
            f'  ·  Diterbitkan: {gen_ts}'
            f'  ·  Nomor: {r.report_number or "-"}'
            f'  ·  Dokumen digital ini sah tanpa tanda tangan basah</font>',
