        ...
        <table className="w-full text-sm table-fixed">
          <thead>
            <tr className="bg-gradient-to-r from-[#0B3D91] to-[#1E5CC6] text-white">
              ...
              <th className="w-[13%] px-3 py-3.5 text-right text-xs font-bold uppercase tracking-wide">Value</th>
              <th className="w-[10%] px-3 py-3.5 text-center text-xs font-bold uppercase tracking-wide">Status</th>
              <th className="w-[10%] px-3 py-3.5 text-center text-xs font-bold uppercase tracking-wide hidden xl:table-cell">Created</th>
              <th className="w-[10%] px-3 py-3.5 text-center text-xs font-bold uppercase tracking-wide hidden xl:table-cell">Modified</th>
              <th className="w-[8%] px-3 py-3.5 text-center text-xs font-bold uppercase tracking-wide">Action</th>
            </tr>
          </thead>
