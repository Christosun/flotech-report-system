...
export default function CreateOnsiteReport() {
  ...
  return (
    <div className="w-full">
      <button onClick={() => navigate("/onsite")} className="flex items-center gap-2 text-sm text-gray-400 hover:text-[#0B3D91] mb-5 transition-colors">← Back</button>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input value={form.client_company} onChange={e => set("client_company", e.target.value)} placeholder="Name of company/agency" className={inputClass} />
            </div>
            <div>
              <label className={labelClass}>Contact Person</label>
              <input value={form.contact_person} onChange={e => set("contact_person", e.target.value)} placeholder="PIC name/contact" className={inputClass} />
            </div>
            <div>
            ...
            <div>
              ...
              <input value={form.site_location} onChange={e => set("site_location", e.target.value)} placeholder="Job site location" className={inputClass} />
            </div>
            <div className="sm:col-span-2">
              <label className={labelClass}>Address</label>
              <input value={form.client_address} onChange={e => set("client_address", e.target.value)} placeholder="Complete address" className={inputClass} />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          <div className="mt-3 bg-blue-50 rounded-xl px-4 py-3">
            <p className="text-xs text-blue-700">💡 <strong>Engineer signature</strong> is taken automatically from the data registered in the Engineers menu.</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-3 mt-6">
        <button onClick={() => navigate("/onsite")} className="px-5 py-3 border border-gray-200 text-gray-600 rounded-xl text-sm font-semibold hover:bg-gray-50">Cancel</button>
        <button onClick={handleSubmit} disabled={saving}
          ...
          {saving ? <><div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> Saving…</> : "🚀 Create an Onsite Report"}
        </button>
      </div>
    </div>
  );
