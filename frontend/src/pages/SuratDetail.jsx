...
export default function SuratDetail() {
  ...
  const handleDelete = async () => {
    setDeleting(true);
    try { await API.delete(`/surat/delete/${id}`); toast.success("Letter deleted"); navigate("/surat"); }
        ...
        <div className="bg-white rounded-2xl border border-amber-200 shadow-sm p-6 mb-4">
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="sm:col-span-2"><label className={labelClass}>Subject</label><input value={form.perihal} onChange={e => set("perihal", e.target.value)} className={inputClass} /></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <div className="space-y-2">
                ...
                <input value={form.pihak_pertama_perusahaan} onChange={e => set("pihak_pertama_perusahaan", e.target.value)} placeholder="Company" className={inputClass} />
                <textarea value={form.pihak_pertama_alamat} onChange={e => set("pihak_pertama_alamat", e.target.value)} placeholder="Address" rows={2} className={inputClass + " resize-none"} />
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2">
                ...
                <input value={form.pihak_kedua_perusahaan} onChange={e => set("pihak_kedua_perusahaan", e.target.value)} placeholder="Company" className={inputClass} />
                <textarea value={form.pihak_kedua_alamat} onChange={e => set("pihak_kedua_alamat", e.target.value)} placeholder="Address" rows={2} className={inputClass + " resize-none"} />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-2">
              {form.barang_items.map((item, i) => (
                <div key={i} className="grid grid-cols-12 gap-2 bg-gray-50 rounded-xl p-2.5 items-center">
                  ...
                  <input className={"col-span-4 " + inputClass} value={item.nama_barang} onChange={e => updateItem(i, "nama_barang", e.target.value)} placeholder="Item Name" />
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                { label: "The Second Party", sig: s.pihak_kedua_signature, nama: s.pihak_kedua_nama, jabatan: s.pihak_kedua_jabatan, perusahaan: s.pihak_kedua_perusahaan },
