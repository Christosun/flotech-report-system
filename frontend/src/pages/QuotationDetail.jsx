      ...
      {!editMode && (
        <div className="space-y-5">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-4 mt-3 text-xs text-blue-100">
                    ...
                    {q.updated_at && q.updated_at !== q.created_at && <span>✏️ Modified: {fmtDT(q.updated_at)}</span>}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">Status Update</h3>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50">
              <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2">🧺 Item &amp; Price</h3>
      ...
      {editMode && form && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
          <div className="p-6 space-y-7">
            ...
            <section>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xs font-extrabold text-[#0B3D91] uppercase tracking-widest">③ Item &amp; Price</h3>
                ...
                {form.items.map((item, i) => (
                  <div key={`edit-item-${i}`} className="bg-gray-50/80 rounded-xl p-4 border border-gray-100">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      {form.items.length > 1 && (
                        <button onClick={() => rmItem(i)} className="text-xs text-red-400 hover:text-red-600 font-semibold">Delete Item</button>
                      )}
                    </div>
          ...
          <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between gap-3 bg-gray-50/50 rounded-b-2xl">
            <p className="text-xs text-gray-400">Changes to items/prices/terms will auto-increment revisions.</p>
            <div className="flex gap-3">
              <button onClick={() => setEditMode(false)}
